    ...
    public static partial class UIWindowLoader
    {
            ...
            int screenHeight)
        {
            ...
            window.InitializePetTabButtons(new[]
            {
                ...
                LoadCanvasStateTabButton(userInfoProperty?["pet"]?["Tab"] as WzSubProperty, "1", device),
                LoadCanvasStateTabButton(userInfoProperty?["pet"]?["Tab"] as WzSubProperty, "2", device)
            });
